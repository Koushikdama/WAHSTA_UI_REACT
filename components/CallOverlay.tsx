...
import { Phone, Video, Mic, MicOff, VideoOff, Maximize2, Minimize2, PhoneOff, User as UserIcon, X } from 'lucide-react';
...
const CallOverlay = () => {
    ...
    const draggingRef = useRef<{ isDragging: boolean, startX: number, startY: number, initialLeft: number, initialTop: number, hasMoved: boolean } | null>(null);
        ...
        <div className="fixed inset-0 z-[100] bg-gray-900 flex flex-col animate-in fade-in duration-300">
            ...
            <div className="bg-[#1f2c34] pb-8 pt-6 px-6 rounded-t-3xl shadow-2xl relative z-20">
                ...
                <div className="flex justify-center items-center gap-6 md:gap-10">
                    ...
                    {/* Dummy Button for styling balance */}
                    <button className="p-4 rounded-full bg-white/5 text-gray-500 cursor-not-allowed">
                        <UserIcon size={24} />
                    </button>
                </div>
            </div>
